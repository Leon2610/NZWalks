...
{
    /// <inheritdoc />
    public partial class SeedingDataforDifficultiesadnRegions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1c52d331-8511-4f08-81d9-7ae80b352a5b"), "Hard" },
                    { new Guid("46a78d6e-b5e3-40a0-a4a3-86e7292b3a22"), "Easy" },
                    { new Guid("a6f0b6ad-2f75-461e-a902-ae0d6071efe5"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1c52d331-8511-4f08-81d9-7ae80b352a5b"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("46a78d6e-b5e3-40a0-a4a3-86e7292b3a22"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a6f0b6ad-2f75-461e-a902-ae0d6071efe5"));
